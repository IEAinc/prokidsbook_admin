              ...
              {getPaginatedData().map((item, idx) => (
                ...
                >
                  {columns.map((col) => (
                    <td
                      key={col.key}
                      className={`dark:border-gray-600 ${col.centerType === "items-center" ? "justify-items-center" : "text-center"
                        }`}
                    >
        ...
        <div className="mt-4 flex items-center justify-center space-x-2">
          ...
          <div className="flex justify-center items-center space-x-2">
            ...
            {Array.from({ length: totalPages }, (_, i) => i + 1).map((page) => (
              <button
                key={page}
                className={`px-3 py-1 mx-1 ${currentPage === page ? "bg-[#E0ECE9]" : "bg-[#f9fafb]"
            ...
            <HiChevronRight
              className={`w-8 h-3 ${currentPage === totalPages ? "opacity-50 cursor-default" : "cursor-pointer"
                }`}
