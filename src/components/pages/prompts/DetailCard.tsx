  ...
  return (
    <div>
      ...
      <div className="bg-white dark:bg-[#252731]  rounded-lg shadow-md">
        <div className="border-b border-gray-300 dark:border-gray-600 rounded-t-lg col-span-8 p-4 bg-[#E0ECE9] dark:bg-zinc-700  font-bold flex text-lg items-center">사용자 입력 상세</div>
              ...
              <div className="flex items-center gap-1">
                {fieldData.categories.map((category, index) => (
                  <React.Fragment key={`category-${index}`}>
                    <span className="inline-flex px-2 py-1 text-sm rounded-2xl bg-gray-300 dark:bg-gray-500 border-gray-400  border-2 ">{category}</span>
                  </React.Fragment>
                ))}
              </div>
              {/* 카테고리 수정 버튼 */}
