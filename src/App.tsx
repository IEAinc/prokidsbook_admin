...
import DetailPage from './components/pages/dashBoard/DetailPage.tsx' //대시보드 상세
//사용자 관리
  ...
  return (
    <Routes>
      ...
      <Route element={<Layout />}>
        ...
        <Route path="/dashboard/visitor" element={<DetailPage type="visitor" title="방문자 수" />} />
        <Route path="/dashboard/download" element={<DetailPage type="download" title="다운로드 수" />} />
        <Route path="/dashboard/user" element={<DetailPage type="account" title="가입자 현황" />} />
        <Route path="/dashboard/story" element={<DetailPage type="stories" title="동화 생성 현황" />} />
        <Route path="/dashboard/character" element={<DetailPage type="characters" title="캐릭터 생성 현황" />} />
